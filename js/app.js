(() => {
    ...
    function hoverImg() {
        ...
        if (itemsImg.length && window.matchMedia("(min-width: 768px)").matches) itemsImg.forEach((item => {
    ...
    function sliders() {
        ...
        if (productsSliders.length) productsSliders.forEach((s => {
    ...
    function overflowTextMore() {
        const overflowItemsRows = document.querySelectorAll(".overflow-text");
        if (overflowItemsRows.length) overflowItemsRows.forEach((item => {
